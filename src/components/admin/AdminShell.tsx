...
import { Award, BookOpen, Image, LayoutGrid, Lock, Map, MessagesSquare, Medal, ShieldAlert, Sparkles, Trophy, Users } from 'lucide-react'
 ...
 return <div className="admin-shell">
  <aside className="admin-sidebar">
   ...
   <nav>
    ...
    <NavLink to="/admin/banners"><Image/> Banners</NavLink>
   </nav>
